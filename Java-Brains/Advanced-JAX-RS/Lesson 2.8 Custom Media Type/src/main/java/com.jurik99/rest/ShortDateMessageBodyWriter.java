...
public class ShortDateMessageBodyWriter implements MessageBodyWriter<Date>
{
	...
	{
		/**
		 * I'm using deprecated method here !
		 * This is for illustration only.
		 * Ideally, use the Calendar class whenever possible, and NOT "Date" !!!
		 */
		final String shortDate = date.getDate() + "-" + date.getMonth() + "-" + date.getYear();
