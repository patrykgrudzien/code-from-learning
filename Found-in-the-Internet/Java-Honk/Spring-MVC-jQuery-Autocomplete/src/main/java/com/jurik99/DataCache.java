...
public class DataCache {
	...
	private static StringBuilder dataCache;
	...
	public static List<String> getName(final String name) {

		final List<String> returnMatchName = new ArrayList<>();
		final String[] data = dataCache.toString().split(",");
