...
public class UserDetails
{
	...
	/**
	 * This ensures that new table "user_details_vehicle" will not be created with "USER_ID" and "VEHICLE_ID"
	 * and instead of that in "Vehicle" table a column "USER_ID" will be added
	 */
