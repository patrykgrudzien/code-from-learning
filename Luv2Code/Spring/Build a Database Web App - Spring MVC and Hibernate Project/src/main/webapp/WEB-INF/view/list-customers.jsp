...
<head>
    ...
    <%-- ${pageContext.request.contextPath} - this gives me proper name of my Application --%>
    ...
    <div id="content">
        ...
        <table>
            ...
            <c:forEach var="tempCustomer" items="${customers}">
                ...
                <%-- conctruct an "update" link with customer id --%>
                <c:url var="updateLink" value="/customer/showFormForUpdate">
                    <c:param name="customerId" value="${tempCustomer.id}"/>
                </c:url>

                <%-- conctruct a "delete" link with customer id --%>
